...
Used for reading, modifying, and saving the CSV dataset.

**re**

Used for regular-expression-based text cleaning.

**NLTK**

Used for different Natural Language Processing operations.
...
The dataset is expected to contain a column named:
...
```text
"This product costs 500 rupees"
```

becomes:

```text
"This product costs  rupees"
```
...
Make sure the dataset contains a column named:
...
After successful execution, the processed dataset will be created at:
